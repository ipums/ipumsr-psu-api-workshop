...
2. .greyed-out[What is ipumsr, and why use it?]

3. .greyed-out[Reading data into R]

4. .greyed-out[Exploring and manipulating metadata]

5. .greyed-out[Brief analysis example]

6. .greyed-out[Working with IPUMS geographic data]

7. .greyed-out[Preview of IPUMS API functionality]
