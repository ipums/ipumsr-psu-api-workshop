...
- More features to come; let us know what you want!
...
```{r, echo=FALSE, fig.alt="Bar plot titled 'How long to read 3 million rows with 13 variables?' ipumsr::read_ipums_micro() is faster than "}
