...
ACS or PRCS, use the replicate weight variables REPWT and REPWTP and follow the
instructions from the IPUMS USA replicate weight FAQ page
[here](https://usa.ipums.org/usa/repwt.shtml#q40).
...
.strong[`7.` API use case 1: Revise your extract]
...
`7.` API use case 1: Revise your extract

.strong[`8.` API use case 2: Share your extract]
...
`8.` API use case 2: Share your extract

.strong[`9.` API use case 3: Share your analysis]
