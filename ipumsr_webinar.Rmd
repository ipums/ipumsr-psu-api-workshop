...
- Public launch early 2022

???
Notice that this is a *preview* of API functionality, because the API is not yet 
publicly available.
...
# IPUMS USA microdata extract API
...
You'll be able to define and submit extract requests

---

# IPUMS USA microdata extract API

## What can't I do via API?
