...
### The data file is **difficult to discern**, the codebook is **easy to discern**

???
Here's my attempt to explain this in a hopefully memorable way: the data file is
difficult to discern (or read), and the codebook is easy to discern

---

# The data file is difficult to discern
...
# The DDI codebook is easy to discern
