...
*So I know you're asking yoursevlves..*
...
# To follow allong with this webinar (29)

Repeat: slides/recording will be available, but if you want to follow along you'll need to clone/download the repo from our github. This provides the data extracts you'll need.

*If you want to use other data, or manually download the extracts...*

You'll have to navigate to navigate to the specific data collection at ipums.org and build a data extract. 

reminder about extract requests
...
"control download links" contains program-specific instructions for reading in the data. The R one contains a couple lines of code that we cover in the next few slides (so you don't need it)
...
# Install R packages (as needed) (32)
...
# Phone availability by education (62)
...
# What can't I do with the API? (72)
...
# Share your extract definition (77)
