...
# Using ipumsr label helper functions (41)




# haven::labelled columns at a glance (42)
...
# Still too detailed for a graph (48)
...
# What can I do with the IPUMS USA API? (57)
...
# What can't I do with the IPUMS USA API? (58)
...
# How to use your IPUMS USA API key (59)
...
# Add HHINCOME to our extract (62)
...
# Update your script with new filename (63)
...
# How to create the extract from scratch (65)
...
# Share your extract (definition) (67)
...
# Instead of hard-coding the extract number... (72)
...
# ...download the data if not available locally! (73)
...
# Then hard-code the renamed files (74)
